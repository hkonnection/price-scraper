...
This file provides universal guidance for working with any AI agent across any project or technology stack.
...
2. At the end of your response, calculate elapsed time
...
**DO NOT SKIP THIS** - Every single response must end with elapsed time and date.
